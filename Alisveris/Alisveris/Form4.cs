...
namespace Alisveris
{
    public partial class Form4 : Form
    {
        ...
        {
            SqlCommand listele = new SqlCommand("select * from urun_tur", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand ekle = new SqlCommand("insert into urun_tur(Tur) values(@tur)", baglanti);
            ekle.Parameters.AddWithValue("@tur", textBox3.Text);
        ...
        {
            baglanti.Open();
            SqlCommand ekle = new SqlCommand("update urun_tur set Tur=@tur where id=@Id ", baglanti);
            ekle.Parameters.AddWithValue("@tur", textBox2.Text);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand ara = new SqlCommand("select * from urun_tur where id=@Id ", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand sil = new SqlCommand("delete from urun_tur  where id=@Id ", baglanti);
